      ...
      <div className="login_box">
        ...
        <div className="login_input_box mb-3">
          ...
          <div className="login_input_container position-relative show_password_input_container">
            <input
              onChange={() => setInvalid({ ...invalid, password: false })}
              ref={passwordRef}
        ...
        <div className="mt-3 text-right">
          <a
            onClick={() => navigate(Locations.FORGOT_PASSWORD)}
        ...
        <div className="text-center pt-3">
          ...
          >
            {loading ? <I18 tkey="Loading..." /> : <I18 tkey="Login" />}
          </button>
        </div>
        <div className="mt-3">
          <I18 tkey="Don't have an account? " />
          <a
            onClick={() => navigate(Locations.SIGN_UP)}
            className="text-primary"
          >
            <I18 tkey="Sign up" />
          </a>
