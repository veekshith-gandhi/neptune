...
import { Button, Card, DatePicker, DatePickerProps, Form, Input, notification, Progress, Select, Space, Typography } from "antd";
import { FunctionComponent, useState } from "react";
import { useDispatch } from "react-redux";
import { HotelResponse } from "../../../../../@types/entity/hotel-entity";
import { submitBasicHotelInfo } from "../../../../../services/hotel-form-api-service";
import { useAppSelector } from "../../../../../store";
import { apiErrorParser } from "../../../../../utils/error-parser";
import { addBasicInfoToHotelCreation, addSubmitedIdToHotel } from "../redux/action";
